...
import com.vkdevlops.cprogramfree.QuestionsModal;
...
public class BookmarkAdapter extends RecyclerView.Adapter<BookmarkAdapter.Viewholder> {
    ...
    List<QuestionsModal> list;

    public BookmarkAdapter(List<QuestionsModal> list) {
        this.list = list;
    }
    ...
    class Viewholder extends RecyclerView.ViewHolder{
        ...
        public Viewholder(@NonNull View itemView) {
            ...
            delete = itemView.findViewById(R.id.delete_bookmark);
